...
Files with the '.node' extension should be serialized bosdyn.api.mission.Node protobufs.  When a walk is
generated, the compiled version of that walk is stored as a '.node' format.
